...
<h4> Now extract/unzip/untar - </h4> 
 ...
 8. Update Alfresco_HOME/tomcat/conf/catalina.properties file. Search for - "shared.loader=" and update it like this shared.loader=${catalina.base}/shared/classes,${catalina.base}/shared/lib/*.jar
